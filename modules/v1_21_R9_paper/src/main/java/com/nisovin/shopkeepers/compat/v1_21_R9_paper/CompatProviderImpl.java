...
public final class CompatProviderImpl implements CompatProvider {
	...
	public void setZombieNautilusVariant(LivingEntity zombieNautilus, NamespacedKey variant) {
		var registry = RegistryAccess.registryAccess().getRegistry(RegistryKey.ZOMBIE_NAUTILUS_VARIANT);
	...
	public NamespacedKey cycleZombieNautilusVariant(NamespacedKey variant, boolean backwards) {
		...
		Registry<ZombieNautilus.Variant> registryNonNull = Unsafe.castNonNull(registry);
		return RegistryUtils.cycleKeyed(registryNonNull, variantValue, backwards).getKey();
	}
}
